...
The R-squared value for the polynomial fit in the plot above is `r round(r2_week, 1)`.
...
The R-squared value for the polynomial fit in the plot above is `r round(r2_month, 1)`.
