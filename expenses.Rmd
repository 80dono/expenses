...
utilities_monthly_cost <- utilities_total_cost %>% 
  ...
  mutate(utility = factor(utility, 
                          levels = c(setdiff(levels(as.factor(utility)),
                                             "Total"), 
                                     "Total")))
...
while (month(temp_month) <= month(today())) {
  water_monthly_proj <- bind_rows(water_monthly_proj, 
                                  data.frame(utility = "Water", year = year(temp_month), month = temp_month, 
                                             real = FALSE, 
